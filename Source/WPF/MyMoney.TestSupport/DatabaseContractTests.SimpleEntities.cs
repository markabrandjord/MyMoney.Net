...
namespace Walkabout.TestSupport
{
    ...
    {
        // protected, not private: SqliteDatabaseContractTests' Backup_ChecksPointsWalBeforeCopying
        // test (SQLite-specific, stays in its own file) also needs a minimal saved Category.
        protected static MyMoney BuildOneCategoryMoney(out Category category)
        {
        ...
        [Test]
        public void SaveOne_UpdateCategoryAfterReload_IncrementsRowVersion()
        {
            BuildOneCategoryMoney(out Category category);
            this.Database.SaveOne(category);
        ...
        [Test]
        public void SaveOne_StaleCategoryRowVersion_ThrowsConcurrencyConflictException()
        {
            BuildOneCategoryMoney(out Category category);
            this.Database.SaveOne(category);
        ...
        [Test]
        public void SaveOne_DeleteCategory_RemovesRowFromDatabaseAndContainer()
        {
            BuildOneCategoryMoney(out Category category);
            this.Database.SaveOne(category);
